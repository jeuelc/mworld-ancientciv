...
/************************ Jammin *******************************/
var bgsoundJammin = new Audio();
bgsoundJammin.src = "audio/Jammin/Jammin_BG.mp3";
bgsoundJammin.addEventListener('ended', function() { bgsoundJammin.play(); });
...
/************************ Rome *******************************/
var bgsoundRome = new Audio();
bgsoundRome.src = "audio/Rome/Rome_BG.mp3";
bgsoundRome.addEventListener('ended', function() { bgsoundRome.play(); });
